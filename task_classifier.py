...
# Streamlit App
st.set_page_config(page_title="⚡ Fast Text Task Classifier", page_icon="⚡", layout="centered")
st.title("⚡ Fast Text Task Classifier & Gemini Chat")
...
# Handle text queries (⚡ streaming output)
